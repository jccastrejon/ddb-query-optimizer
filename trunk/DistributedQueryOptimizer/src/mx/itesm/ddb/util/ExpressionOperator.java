...
public interface ExpressionOperator {
	...
	ADD_OPERATOR("+"), SUBSTRACT_OPERATOR("-"), MULTIPLY_OPERATOR("*"), DIVIDE_OPERATOR("/"), DIFFERENT_THAN_OPERATOR(
		"!="), EQUALS_TO_OPERATOR("="), GREATER_THAN_OPERATOR(">"), LESS_THAN_OPERATOR("<"), GREATER_THAN_OR_EQUALS_OPERATOR(
